...
if __name__ == "__main__":
    ...
    if rosette_mode:
        create_rosette(img_path, diameter_in=diam, total_gores=total_gores,
                       min_lat_deg=min_lat)
    else:
        create_sheets(img_path, diameter_in=diam, total_gores=total_gores,
                      gores_per_sheet=gores_per_sheet, min_lat_deg=min_lat,
                      mirror=mirror_mode)
